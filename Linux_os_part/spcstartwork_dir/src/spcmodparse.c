...
//
int _getCheckBlock(const char *path, uint32_t *pServerId, unsigned char *dest)
{
	//open file
	int fd = -1;
...
int _getAesData(char *path, unsigned char *buf, uint32_t len)
{
